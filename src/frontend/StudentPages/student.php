...
<head>
    ...
    <link rel="Stylesheet" href="./../../../style/StudentPages/student.css?<?php echo time();?>"/>
        ...
        <div class="studentLanding">
            ...
            <div class="form-buttons">
                <form action="./takeExam.php">
                    <input type="submit" id="takeExam" class="buttons" name="b1" value="Take Exam">
                </form>
                <form action="./reviewExam.php">
                    <input type="submit" id="reviewExam" class="buttons" name="b2" value="Review Exam">
                </form>
            </div>
        </div>
    </div>
